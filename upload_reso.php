        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p>This is to store all the Resolutions</p>
              <div class="alert alert-warning">
        Allowed Type are [Word Docs and PDF only]***
      </div>

      <form method="POST" action="process_upload_reso.php" enctype="multipart/form-data" id="to_upload" class="form-control needs-validation" novalidate>
    ...
    <p id="fp"></p>
        ...
        <div class="card">
            <div class="card-body">
              ...
              <h5 class="card-title">Overall Uploaded Resolution</h5>
              <p>Listed below are Uploaded Resolution to this Digital Storage.</p>
                  ...
                  $message = '';
                    $get_orders = mysqli_query($db,"select * from resolution ORDER BY date ASC");
                            if(mysqli_num_rows($get_orders)>= 1){ 
                              ...
                              ?>
                      <tr>
                        <td><a href="view_reso.php?file=<?=$rows2['orig_name']?>"><img height='20px' width='20px' src='assets/img/<?=$icon?>'></img> <?=$rows2['orig_name']?></a></td>
                        <td><?=$time_in?></td>
