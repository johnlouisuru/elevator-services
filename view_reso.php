      ...
      <div class="row">
        ...
        <div class="card">
            <div class="card-body">
              ...
              <p>Listed below are Resolution Uploaded to this Digital Storage.</p>

              <div class='col-md-12'><div class='card-body'><div class='form-control'><center>
                <iframe src="resolution/<?=$_GET['file']?>" width="100%" height="1000px" /></iframe>
                <br><a href='resolution/<?=$_GET['file']?>'>Click here to Download</a></center></div></div></div>
